...
const SalesInvoicePage = () => {
  ...
  const printDefaultFormat = (invoice, org, template, printCurrency = 'USD', withBackground = true) => {
    ...
    pw.document.write('<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Invoice ' + (invoice?.invoice_number || '') + '</title><style>'
      ...
      + 'table.it th{background:#fff;color:#000;padding:7px 4px;font-size:11px;border:2px solid #000;font-weight:bold}'
      ...
      + '.tot .gt td{font-size:15px;font-weight:bold;border:2px solid #000}'
